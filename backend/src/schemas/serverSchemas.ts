...
export const credentialTypeEnum = z.enum(['NONE', 'SSH_KEY', 'PASSWORD']);
export const credentialKeyFormatEnum = z.enum(['PEM', 'PPK']);
...
export const createServerSchema = z.object({
  ...
  credentialType: credentialTypeEnum.default('NONE'),
  keyFormat: credentialKeyFormatEnum.optional(),
  password: z.string().min(1).optional(),
});

export const updateServerSchema = createServerSchema
  .omit({ credentialType: true, keyFormat: true, password: true })
  .partial()
  .extend({
