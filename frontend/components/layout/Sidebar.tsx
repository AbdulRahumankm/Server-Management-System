...
export function Sidebar() {
  ...
  return (
    <nav className="hidden w-56 flex-shrink-0 border-r border-slate-200 bg-white p-4 sm:block">
      <div className="mb-6 px-3 text-lg font-semibold">Server Inventory</div>
